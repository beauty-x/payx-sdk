...
abstract class ApiResource extends PayXObject
{
    private static $HEADERS_TO_PERSIST = array('PayX-Version' => true);
    ...
    public static function className()
    {
        ...
        if (substr($class, 0, strlen('PayX')) == 'PayX') {
            $class = substr($class, strlen('PayX'));
        }
    ...
    private static function _validateParams($params = null)
    {
        if ($params && !is_array($params)) {
            $message = "You must pass an array as the first argument to PayX API "
               . "method calls.";
    ...
    protected static function _all($params = null, $options = null)
    {
        ...
        return Util\Util::convertToPayXObject($response, $opts);
    }
