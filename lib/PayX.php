...
{
    /**
     * @var string The PayX API key to be used for requests.
     */
    public static $apiKey;
    /**
     * @var string The base URL for the PayX API.
     */
    public static $apiBase = 'https://pay.kongqueyun.com';
    /**
     * @var string|null The version of the PayX API to use for requests.
     */
